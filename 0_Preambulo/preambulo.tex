...
\nomenclature{$BMS$}{Building Management System\\Sistema de Gestión de Edificaciones}
\nomenclature{$DDC$}{Direct Digital Control\\Control Digital Directo}
\nomenclature{$SCADA$}{Supervisory Control And Data Acquisition\\
Control de Supervisión y Adquisición de Datos}
\nomenclature{$BACnet MS/TP$}{Building Automation and Control Networks Master-Slave/Token-Passing\\
Automatización de Edificios y Redes de Control de paso de testigo  Maestro-Esclavo}
\nomenclature{$PLC$}{Programmable Logic Controller\\ Controlador lógico programable}
\nomenclature{$ASHRAE$}{American Society of Heating, Refrigerating and Air-Conditioning Engineers\\ Sociedad Americana de Ingenieros de Calefacción, Refrigeración y Aire Acondicionado}
\nomenclature{$FC$}{Field Controller\\ Controlador de campo}
\nomenclature{$SA$}{Sensor Actuator\\ Actuador de sensor}
\nomenclature{$NCM$}{Network Control Module\\ Módulo de control de red}
\nomenclature{$HVAC$}{Heating Ventilation and Air Conditioning\\ Sistema de Calefacción, Ventilación y Aire Acondicionado}
\nomenclature{$UMA$}{Unidad Manejadora de Aire}
\nomenclature{$VFD$}{Variable Frequency Drive\\ Variador de Frecuencia}
